...
/// let result = Sha224::new().update(b"").digest();
...
/// let result = Sha256::new().update(b"").digest();
/// assert_eq!(result, hash);
///
/// ```
...
/// let result = Sha384::new().update(b"").digest();
/// assert_eq!(result, hash);
///
/// ```
...
/// let result = Sha512::new().update(b"").digest();
/// assert_eq!(result, hash);
///
/// ```
...
/// let result = Sha512_224::new().update(b"").digest();
/// assert_eq!(result, hash);
///
/// ```
...
/// let result = Sha512_256::new().update(b"").digest();
/// assert_eq!(result, hash);
///
/// ```
